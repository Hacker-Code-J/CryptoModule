...
\begin{tikzpicture}[x=1cm, y=-0.07cm, font=\footnotesize, draw=black, >=Stealth, scale=.8]
	...
	\node[anchor=south] at (1.5,0) {\textbf{BlockCipherContext (128 bytes)}};
	\node at (1.5,4) {BlockCipherApi* \textit{api} \\ (8 bytes)};
	\node at (1.5,68) {CipherInternal \textit{internal\_data} \\ (union, 120 bytes)};
	
	\node[anchor=east] at (0,0) {{\tiny 0x00}};   % top address
	\node[anchor=east] at (0,8) {{\tiny 0x08}};
	\node[anchor=east] at (0,128) {{\tiny 0x80}};
	...
	\draw[densely dashed] (3,8) -- ++(14,0) node[anchor=west]{\tiny Union base (0x08)};
	...
	\draw (5,24) -- ++(3,0);
	\draw (5,76) -- ++(3,0);
	\node[anchor=south] at (6.5,8) {\textbf{aes\_internal (80 bytes)}};
	\node at (6.5,12) {size\_t \textit{block\_size} \\ (8 bytes)};
	\node at (6.5,20) {size\_t \textit{key\_len} \\ (8 bytes)};
	\node at (6.5,50) {u8 \textit{round\_keys[60]} \\ (60 bytes)};
	\node at (6.5,80) {int \textit{nr} \\ (4 bytes)};
	\node[color=gray] at (6.5,100) {{\footnotesize (unused 40 bytes)}};
	...
	\draw (9,24) -- ++(3,0);
	\draw (9,76) -- ++(3,0);
	\node[anchor=south] at (10.5,8) {\textbf{aria\_internal (80 bytes)}};
	\node at (10.5,12) {size\_t \textit{block\_size} \\ (8 bytes)};
	\node at (10.5,20) {size\_t \textit{key\_len} \\ (8 bytes)};
	\node at (10.5,50) {u8 \textit{round\_keys[60]} \\ (60 bytes)};
	\node at (10.5,80) {int \textit{nr} \\ (4 bytes)};
	\node[color=gray] at (10.5,100) {{\footnotesize (unused 40 bytes)}};
	...
	\draw (13,24) -- ++(3,0);
	\draw (13,112) -- ++(3,0);
	\node[anchor=south] at (14.5,8) {\textbf{lea\_internal (120 bytes)}};
	\node at (14.5,12) {size\_t \textit{block\_size} \\ (8 bytes)};
	\node at (14.5,20) {size\_t \textit{key\_len} \\ (8 bytes)};
	\node at (14.5,60) {u8 \textit{round\_keys[96]} \\ (96 bytes)};
	\node at (14.5,116) {int \textit{nr} \\ (4 bytes)};
	\node[color=gray] at (14.5,124) {{\footnotesize (+4B pad)}};
	...
	\draw[decorate,decoration={brace,amplitude=4pt}] (5,130) -- node[above=4pt]{\small Union members (share same memory)} (16,130);
	
	% BlockCipherApi vtable structure (40 bytes)
	% Place vtable below (starting at y=140 for offset 0)
	\draw[thick] (0,140) rectangle ++(3,40);
	\draw[thick] (0,148) -- ++(3,0);
	\draw[thick] (0,156) -- ++(3,0);
	\draw[thick] (0,164) -- ++(3,0);
	\draw[thick] (0,172) -- ++(3,0);
	\node[anchor=south] at (1.5,140) {\textbf{BlockCipherApi (vtable)}};
	\node at (1.5,144) {const char* \textit{name} \\ (8 bytes)};
	\node at (1.5,152) {\textit{init} (func ptr, 8B)};
	\node at (1.5,160) {\textit{encrypt\_block} (func ptr, 8B)};
	\node at (1.5,168) {\textit{decrypt\_block} (func ptr, 8B)};
	\node at (1.5,176) {\textit{dispose} (func ptr, 8B)};
	\node[anchor=east] at (0,140) {{\tiny 0x00}};
	\node[anchor=east] at (0,148) {{\tiny 0x08}};
	\node[anchor=east] at (0,156) {{\tiny 0x10}};
	\node[anchor=east] at (0,164) {{\tiny 0x18}};
	\node[anchor=east] at (0,172) {{\tiny 0x20}};
	\node[anchor=east] at (0,180) {{\tiny 0x28}};
	
	% Arrows: BlockCipherContext.api -> vtable, and vtable function ptrs -> functions
	% API pointer arrow (from BCC.api field to vtable)
	\draw[->, thick] (0,4) -| (-1,4) |- (-1,140) -| (0,140);
	
	% Function implementation nodes for AES
	\node[draw, anchor=west, fill=gray!10] (fn_init)        at (6,152) {\texttt{aes\_init()}};
	\node[draw, anchor=west, fill=gray!10] (fn_encrypt)     at (6,160) {\texttt{aes\_encrypt()}};
	\node[draw, anchor=west, fill=gray!10] (fn_decrypt)     at (6,168) {\texttt{aes\_decrypt()}};
	\node[draw, anchor=west, fill=gray!10] (fn_dispose)     at (6,176) {\texttt{aes\_dispose()}};
	
	\draw[->] (3,152) -- (fn_init.west);
	\draw[->] (3,160) -- (fn_encrypt.west);
	\draw[->] (3,168) -- (fn_decrypt.west);
	\draw[->] (3,176) -- (fn_dispose.west);
\end{tikzpicture}
