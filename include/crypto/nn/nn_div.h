...
/* int nn_divrem(nn_t q, nn_t r, nn_src_t a, nn_src_t b); (declared in public header) */
...
/* Compute r = a mod b */
/* int nn_mod(nn_t r, nn_src_t a, nn_src_t b); (declared in public header) */
...
/* int nn_gcd(nn_t d, nn_src_t a, nn_src_t b, int *sign); (declared in public header) */
/* int nn_xgcd(nn_t g, nn_t u, nn_t v, nn_src_t a, nn_src_t b, int *sign); (declared in public header) */
