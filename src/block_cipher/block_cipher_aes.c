...
// void aes_dispose(BlockCipherContext *ctx) {
//     if (!ctx || !ctx->internal_data.aes_internal.round_keys) return;
//     // Zero out sensitive data
//     memset(ctx->internal_data.aes_internal.round_keys, 0, sizeof(ctx->internal_data.aes_internal.round_keys));
//     // Reset the internal AES context
//     memset(&ctx->internal_data.aes_internal, 0, sizeof(ctx->internal_data.aes_internal));
